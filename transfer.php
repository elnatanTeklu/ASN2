...
$dbc = mysqli_connect('localhost', 'e1, '1', 'banking') OR die('Could not connect to MySQL: ' . mysqli_connect_error() );
...
<p><input type="submit" name="submit" value="Submit"><form action="index.php">
